...
typedef struct srt_hdr {
	...
	unsigned int seq_num;			//sequence number, used for data transmission. you will not use them in lab4
	unsigned int ack_num;			//ack number, used for data transmission. you will not use them in lab4
